...
studio.menu.addMenuItem({ 
    name: "Export Haxe Type and Build Banks",  
...
function saveUserChoicesToFile(outputDir, generateConsts, generateEnums) {
...
function writeConstantsFileBody(file) {
    file.writeText("package;\r\n\r\n")

    // Write header for file
    file.writeText(generatedInfoHeader);
    ...
    file.writeText("class FmodSongs {\r\n");
    allMusic.forEach(function(event) {
        file.writeText("    public static inline var " + event.name + ":String = \"" + event.path + "\";\r\n");
    });
    file.writeText("}\r\n\r\n");
    
    // Generate constants for sfx events
    console.log("Exporting SFX events")
    file.writeText("class FmodSFX {\r\n");
    ...
    file.writeText("class FmodBus {\r\n");
    allBusses.forEach(function(obj) {
        file.writeText("    public static inline var " + obj.name + ":String = \"" + obj.path + "\";\r\n");
    });
    file.writeText("}\r\n");
}
